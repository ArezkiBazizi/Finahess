...
urlpatterns = [
    ...
    path('set-savings-target/', views.set_savings_target, name='set_savings_target'),
    path('add-expense/', views.add_expense, name='add_expense'),
    path('update-initial-savings/', views.update_initial_savings, name='update_initial_savings'),
    path('api/savings/simulate/<int:months>/', views.savings_simulate_api, name='savings_simulate_api'),
] 